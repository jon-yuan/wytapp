...
import com.babuwyt.consignor.bean.GuijiBean;
import com.babuwyt.consignor.entity.resultEntity;
...
public class GuijiActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fid = getIntent().getStringExtra("orderId");
        init();
        initMap();
        getGuiji();
    }
...
//        aMap.setTrafficEnabled(true);// 显示实时交通状况
    ...
    private void getGuiji() {
        ...
        public void onError (Throwable ex,boolean isOnCallback){
            loadingDialog.dissDialog();
            Log.d("==Throwable==",ex+"");
            UHelper.showToast(GuijiActivity.this,getString(R.string.NET_ERROR));
        }
    });
